...
class BaseAsyncIOLoop(IOLoop):
    def initialize(self, asyncio_loop, **kwargs):
        print('base init')
        self.asyncio_loop = asyncio_loop  #get_event_loop
        print('loop2 ',self.asyncio_loop,id(self.asyncio_loop))
        ...
        print('len _ioloop_for',len(IOLoop._ioloop_for_asyncio))
...
#        print('self',self)
        #self <tornado.platform.asyncio.AsyncIOMainLoop object at 0x0000021FC7BAC0F0>
