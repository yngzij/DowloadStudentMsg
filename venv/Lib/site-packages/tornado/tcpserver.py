...
class TCPServer(object):
    ...
    def __init__(self, ssl_options=None, max_buffer_size=None,
        ...
        print(ssl_options,max_buffer_size,read_chunk_size)
    ...
    def listen(self, port, address=""):
        ...
        the `.IOLoop`.
        """
        sockets = bind_sockets(port, address=address) #创建一个服务器socket 并且加入到sockets中
        self.add_sockets(sockets)  #添加socket并且进行监听


    def add_sockets(self, sockets:list):
        print('add_sockets')
        ...
        for sock in sockets:
            ...
            #self._sockets is dict
            #self._handlers={} 保存着所有的主机名对应的Handlers，每个handlers则是url正则对应的Handler
    ...
    def start(self, num_processes=1):
        ...
        默认情况下，我们在这个过程中运行服务器，并且不fork子程序
